...
<body id="theme-switcher" class="light-theme">
    ...
    <script>
        ...
        let countdown = 10;
        alertDiv.innerHTML = `You are seeing this because we are building the login page. <b><i>This is the Free to use Limited Functional Page</i></b> Redirecting in ${countdown} seconds...<br> if you want to see Post login page click <a target="_blank" href="PostLogIN.php">Hear</a><br>`;
